...
<link
	href="http://ironsummitmedia.github.io/startbootstrap-sb-admin-2/dist/css/sb-admin-2.css"
	rel="stylesheet">
<link rel="stylesheet"
	href="http://ironsummitmedia.github.io/startbootstrap-sb-admin-2/bower_components/font-awesome/css/font-awesome.min.css">
<!-- Page Specific CSS -->
<link rel="stylesheet"
...
$(document).ready(function()
	...
	$("#"+${countinn1}+"wik").removeClass( "collapse" );
	        ...
	        var img="";
	        var out = /(OUT)/;
	        var bowled = /(Bowled|BOWLED|bowled)/;
	        var six = /(SIX)/;
	        var four = /(FOUR)/;
	        var wide = /(Wide|wide|WIDE)/;
	        var nb = /(No ball)/;
	        var sol = /(Short of a length)/;
	        var bouncer = /(Bouncer|bouncer)/;
	        var appeal = /(Appeal|appeal)/;
	        var rout = /(RUN OUT|Run Out|run out)/;
	        var walksin = /(walks in)/;
	        var stumped = /(Stumped)/;
	        var mos = /(Man of the series)/;
	        var mom = /(Man of the Match)/;
	        var catch1 = /(Caught|Catch|CAUGHT|CATCH|caught)/;
	        ...
	        {	comm="";
	        	...
	        	var flickerAPI = "https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20cricket.commentary%20where%20match_id%3D"+matchId+"&format=json&diagnostics=true&env=store%3A%2F%2F0TxIGQMQbObzvU4Apia0V0&callback=";
		        		      ...
		        		      $.each( data.query.results.Over, function( i, item ) {
		        		    	  $.each( item.Ball, function( i1, ball ) {
		        		    		  if(ball.pis.o>0 && isLatest=="N"){
		        		    			  ...
		        		    			  mailComm=ball.c;
		        		    			  mailShm=ball.shc;
		        		    		  }else if(ball.pis.o>0 && isLatest<ball.pis.o){
		        		    			  isLatest=ball.pis.o;
		        		    			  isMail1="Y";
		        		    			  //alert(isLatest + " : " + isMail1);
		        		    			  mailComm=ball.c;
		        		    		  ...
		        		    		  if(Boolean(ball.c.match(out))){
		        		    			  img="<img src='http://www.scoreit.in/resources/img/c/out.gif' class='pic img-circle' width='100' height='100' />";
		        		    			  img1="http://www.scoreit.in/resources/img/c/out.gif";
		        		    			  isMail2="Y";
		        		    		  }else if(Boolean(ball.c.match(six))){
		        		    			  img="<img src='http://www.scoreit.in/resources/img/c/6.gif' class='pic img-circle' width='100' height='100' />";
		        		    			  img1="http://www.scoreit.in/resources/img/c/6.gif";
		        		    			  isMail2="Y";
		        		    		  }else if(Boolean(ball.c.match(four))){
		        		    			  img="<img src='http://www.scoreit.in/resources/img/c/wow.gif' class='pic img-circle' width='100' height='100' />";
		        		    			  img1="http://www.scoreit.in/resources/img/c/wow.gif";
		        		    		  }else if(Boolean(ball.c.match(mom))){
		        		    			  img="<img src='http://www.scoreit.in/resources/img/c/kohli.gif' class='pic img-circle' width='100' height='100' />";
		        		    			  img1="http://www.scoreit.in/resources/img/c/kohli.gif";
		        		    			  isMail2="Y";
		        		    		  }else if(Boolean(ball.c.match(catch1))){
		        		    			  img="<img src='http://www.scoreit.in/resources/img/c/whtacatch.gif' class='pic img-circle' width='100' height='100' />";
		        		    			  img1="http://www.scoreit.in/resources/img/c/whtacatch.gif";
		        		    			  isMail2="Y";
		        		    		  }else if(Boolean(ball.c.match(wide))||Boolean(ball.c.match(nb))||Boolean(ball.c.match(bouncer))){
		        		    			  img="<img src='http://www.scoreit.in/resources/img/c/no.gif' class='pic img-circle' width='100' height='100' />";
		        		    			  img1="http://www.scoreit.in/resources/img/c/no.gif";
		        		    		  }else if(Boolean(ball.c.match(mos))){
		        		    			  img="<img src='http://www.scoreit.in/resources/img/c/kohli.gif' class='pic img-circle' width='100' height='100' />";
		        		    			  img1="http://www.scoreit.in/resources/img/c/kohli.gif";
		        		    			  isMail2="Y";
		        		    		  }else{
		        		    			  switch (Math.floor((Math.random() * 10) + 1)) {
		        		    			    case 1:
		        		    			    	img="<img src='/resources/img/c/holdee.gif' class='pic img-circle' width='100' height='100' />";
		        		    			        break;
		        		    			    case 2:
		        		    			    	img="<img src='/resources/img/c/IMG_1375.gif' class='pic img-circle' width='100' height='100' />";
		        		    			        break;
		        		    			    case 3:
		        		    			    	img="<img src='/resources/img/c/sleepy.gif' class='pic img-circle' width='100' height='100' />";
		        		    			        break;
		        		    			    case 4:
		        		    			    	img="<img src='/resources/img/c/drunk.gif' class='pic img-circle' width='100' height='100' />";
		        		    			        break;
		        		    			    case 5:
		        		    			    	img="<img src='/resources/img/c/irritated.gif' class='pic img-circle' width='100' height='100' />";
		        		    			        break;
		        		    			    case 6:
		        		    			    	img="<img src='/resources/img/c/IMG_1375.gif' class='pic img-circle' width='100' height='100' />";
		        		    			        break;
		        		    			    case 9:
		        		    			    	img="<img src='/resources/img/c/angry.gif' class='pic img-circle' width='100' height='100' />";
		        		    			        break;
		        		    			    case 7:
		        		    			    	img="<img src='/resources/img/c/sleepy.gif' class='pic img-circle' width='100' height='100' />";
		        		    			        break;
		        		    		  ...
		        		    		  //out types image
		        		    		  if(Boolean(ball.c.match(appeal))){
		        		    			  img="<img src='http://www.scoreit.in/resources/img/c/howzaat.gif' class='pic img-circle' width='100' height='100' />";
		        		    			  img1="http://www.scoreit.in/resources/img/c/howzaat.gif";
		        		    			  isMail2="Y";
		        		    		  }else if(Boolean(ball.c.match(catch1))){
		        		    			  img="<img src='http://www.scoreit.in/resources/img/c/whtacatch.gif' class='pic img-circle' width='100' height='100' />";
		        		    		  }else if(Boolean(ball.c.match(rout))){
		        		    			  img="<img src='http://www.scoreit.in/resources/img/c/oh-nooo.gif' class='pic img-circle' width='100' height='100' />";
		        		    			  img1="http://www.scoreit.in/resources/img/c/oh-nooo.gif";
		        		    			  isMail2="Y";
		        		    		  }else if(Boolean(ball.c.match(stumped))){
		        		    			  img="<img src='http://www.scoreit.in/resources/img/c/IMG_1373.gif' class='pic img-circle' width='100' height='100' />";
		        		    			  isMail2="Y";
		        		    		  }else if(Boolean(ball.c.match(bowled))){
		        		    			  img="<img src='http://www.scoreit.in/resources/img/c/bowled.gif' class='pic img-circle' width='100' height='100' />";
		        		    		  }
		        		    		  //
	        		      ...
	        		      //alert(isMail1);
		        		  //alert(isMail2);
		        		  if(isMail1=="Y" && isMail2=="Y"){
		        			  alert("mail sent");
		        			  $.post("http://www.scoreit.in/cricket/upStatus",
		        					    {
		        				  			message: img+mailComm,
		        				  			file:img1,
		        				  			sub: mailShm
		        					    });
...
<script
	src="http://ironsummitmedia.github.io/startbootstrap-sb-admin-2/dist/js/sb-admin-2.js"></script>
