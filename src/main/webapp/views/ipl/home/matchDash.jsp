	        		    	  ...
	        		    	  $.each( item.Ball, function( i1, ball ) {
	        		    		  if((ball.ov-1)>0 && isLatest=="N"){
	        		    			  ...
	        		    			  if(ball.type!="ball"){
	        		    				  ...
	        		    				  readComm=ball.shc+". "+ball.c+" . End of the over. "+(ball.tl)+" per "+ ball.wkts+" off "+ball.pis.o;  
	        		    			  }else{
	        		    				  readComm=ball.shc+". "+ball.c;
									  }
	        		    			  
	        		    			  var u1 = new SpeechSynthesisUtterance(readComm.replace("<b>", " ").replace("</b>", " ").substring(0,250));
										u1.lang = 'en-US';
										u1.pitch = 100;
										u1.rate = 2;
										//u1.voice = voices[10];
	        		    			  ...
	        		    			  if(ball.type!="ball"){
	        		    				  ...
	        		    				  readComm=(ball.tl)+" per "+ ball.wkts+" off "+ball.pis.o+". " +ball.shc+". "+ball.c;  
	        		    			  }else{
	        		    				  readComm=ball.shc+". "+ball.c;
									  }
	        		    			  var u1 = new SpeechSynthesisUtterance(readComm.replace("<b>", " ").replace("</b>", " ").substring(0,250));
	        		    		  ...
	        		    		  if(Boolean(ball.c.match(out))){
	        		    			  img="<img src='/resources/img/c/out.gif' class='pic img-circle' width='100' height='100' />";
	        		    			  isMail2="Y";
	        		    		  }else if(Boolean(ball.c.match(six))){
	        		    			  img="<img src='/resources/img/c/6.gif' class='pic img-circle' width='100' height='100' />";
	        		    			  isMail2="Y";
	        		    		  }else if(Boolean(ball.c.match(four))){
	        		    			  img="<img src='/resources/img/c/wow.gif' class='pic img-circle' width='100' height='100' />";
	        		    		  }else if(Boolean(ball.c.match(mom))){
	        		    			  img="<img src='/resources/img/c/kohli.gif' class='pic img-circle' width='100' height='100' />";
	        		    			  isMail2="Y";
	        		    		  }else if(Boolean(ball.c.match(catch1))){
	        		    			  img="<img src='/resources/img/c/whtacatch.gif' class='pic img-circle' width='100' height='100' />";
	        		    			  isMail2="Y";
	        		    		  }else if(Boolean(ball.c.match(wide))||Boolean(ball.c.match(nb))||Boolean(ball.c.match(bouncer))){
	        		    			  img="<img src='/resources/img/c/no.gif' class='pic img-circle' width='100' height='100' />";
	        		    		  ...
	        		    		  if(Boolean(ball.c.match(appeal))){
	        		    			  img="<img src='/resources/img/c/howzaat.gif' class='pic img-circle' width='100' height='100' />";
	        		    			  isMail2="Y";
	        		    		  }else if(Boolean(ball.c.match(catch1))){
	        		    			  img="<img src='/resources/img/c/whtacatch.gif' class='pic img-circle' width='100' height='100' />";
	        		    		  }else if(Boolean(ball.c.match(rout))){
	        		    			  img="<img src='/resources/img/c/oh-nooo.gif' class='pic img-circle' width='100' height='100' />";
	        		    			  isMail2="Y";
	        		    		  }else if(Boolean(ball.c.match(stumped))){
	        		    			  img="<img src='/resources/img/c/IMG_1373.gif' class='pic img-circle' width='100' height='100' />";
	        		    			  isMail2="Y";
	        		    		  }else if(Boolean(ball.c.match(bowled))){
	        		    			  img="<img src='/resources/img/c/bowled.gif' class='pic img-circle' width='100' height='100' />";
	        		    		  }
	        		    		  //
